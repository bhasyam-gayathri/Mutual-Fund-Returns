...
# --------------
# Code starts here
fig,[ax_1,ax_2] = plt.subplots(1,2,figsize = (9,10))
#print(data['price_earning'])
...
ridge_rmse = np.sqrt(mean_squared_error(y_ridge_pred,y_test))
print(ridge_rmse)
lasso_model = Lasso()
lasso_grid = GridSearchCV(estimator = lasso_model,param_grid = dict(alpha = lasso_lambdas))
lasso_grid.fit(X_train,y_train)
y_lasso_pred = lasso_grid.predict(X_test)
lasso_rmse = np.sqrt(mean_squared_error(y_lasso_pred,y_test))
print(lasso_rmse)
# Code ends here
